...
public class iPhones extends Phone implements Smartphones {
    ...
    public iPhones(String phoneNumber, double phoneBalance, double callDuration, int smsAmount, double internetDuration) {
        super(phoneNumber);
